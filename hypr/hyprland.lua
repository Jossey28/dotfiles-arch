...
local menu	  = "fuzzel"
local clipboardManager = "cliphist list | fuzzel --dmenu | cliphist decode | wl-copy"
    ...
    -- hl.window_rule({
      ...
      -- hl.window_rule({
        ...
        hl.config({
          ...
          -- Example special workspace (magicpad)
...
local status, value = pcall(require, "keybinds.lua")
if status then
  print("successfully loaded keybinds, it returned:", value)
else
  print("failed to load keybinds, its error message was:", value)
end
